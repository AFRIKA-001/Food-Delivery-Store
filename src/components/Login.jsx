...
event.preventDefault();
  ...
  return ( 
  <Modal open={userLoginContext.Login === 'login'} className='h-100 w-200 m-auto backdrop:bg-stone-900/90 rounded bg-slate-300'>
    <h1 className='text-3xl font-sans text-center p-4'>Login</h1>
    <form onSubmit={handleLogin} className='bg-amber-300 rounded flex flex-col lg:h-70 lg:w-100 mx-auto md:p-4 lg:p-8'>
        ...
        <button onClick={HideLogin} type='reset' className='bg-amber-500 rounded-4xl active:bg-amber-700 w-50 mx-auto hover:bg-amber-600'>Create Account</button>
    </form>
 <button ></button>
  </Modal>
