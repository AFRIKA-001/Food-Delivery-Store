...
function MealCard({meals}) {
  ...
  return (
    <div className=' border rounded-sm line-clamp-1 hover:shadow-2xl object-cover md:h-60 lg:h-120 bg-white 
     ...
     '>
        <img  className="  h-80 w-full object-cover"  src={meals.image_url} alt="food image" />
